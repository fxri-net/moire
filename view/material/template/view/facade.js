...
fxView['machine']['deployer'](['material', 'template', 'view'], {
  search: '' + '<form class="layui-form layui-elem-quote layui-col-space5 moire-clear moire-search"></form>',
  table: '' + '<div id="moire-table" class="moire-table" lay-filter="moire-table"></div>',
  view:
    '' +
