...
fxView['layui'] = Object.assign(isObject(fxView['layui']) ? fxView['layui'] : {}, {
          ...
          if ($(this).text() != '') {
            $(this).html(
              $(this).html() +
                ...
                '<a fxy-type="1">' +
                fxBase['base']['lang'](['lay 全选']) +
                '</a>' +
                '<a fxy-type="2">' +
                fxBase['base']['lang'](['lay 清空']) +
                '</a>' +
                '<a fxy-type="3">' +
                fxBase['base']['lang'](['lay 反选']) +
                '</a>' +
                '</span>',
            )
          }
  ...
  select: function () {
    ...
    function start(event) {
      ...
      tray['elemW'] =
        tray['elem'].find('span:last').offset().left +
        tray['elem'].find('span:last').outerWidth(true) +
        parseInt(tray['elem'].css('padding-left')) -
        tray['elem'].find('span:first').offset().left
