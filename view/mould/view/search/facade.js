 ...
 * 云纹模具-视图-搜索
 */
fxView['machine']['deployer'](['mould', 'view', 'search', 'main'], function () {
  // 初始化变量
  var dark = [
    // 参数
    null,
  ...
  // 检查皮肤
  if (!isFunction(fxView['machine']['caller'](['mould', 'view', 'search', 'skin', dark[1]]))) {
  ...
  // 执行皮肤
  fxView['machine']['caller'](['mould', 'view', 'search', 'skin', dark[1]], dark)
  // 渲染之后
