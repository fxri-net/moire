 ...
 * 云纹模具-工具-窗口
 */
fxView['machine']['deployer'](['mould', 'tool', 'window', 'main'], function () {
  // 初始化变量
  var dark = [
    // 参数
    null,
  ...
  // 检查皮肤
  if (!isFunction(fxView['machine']['caller'](['mould', 'tool', 'window', 'skin', dark[1]]))) {
  ...
  // 执行皮肤
  fxView['machine']['caller'](['mould', 'tool', 'window', 'skin', dark[1]], dark)
  // 渲染之后
